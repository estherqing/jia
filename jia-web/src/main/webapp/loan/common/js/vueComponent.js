...
(function(){
    return vueComponent={
        inputComponent:Vue.extend({
            ...
            '<input type="text" class="form-control" :placeholder="placeholder" :class="class" :id="id" :name="name" :readonly="readonly" :disabled="disabled" :value="value">'+
            //'<span class="input-group-btn">' +
            //'<slot></slot>' +
            //'</span>' +
            '<slot></slot>'+
            '</div>'+
            '<input v-model="m" type="text" class="form-control" :class="class" :id="id" :name="name" :readonly="readonly" :disabled="disabled" :value="value" :placeholder="placeholder" v-else>'+
            '</div>'+
            '</div>',
            methods:{
        ...
        tableComp:Vue.extend({
            props:['class','id','field','options','ajax','checkbox','formatter','events'],
