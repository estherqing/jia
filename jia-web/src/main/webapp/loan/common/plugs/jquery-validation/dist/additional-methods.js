...
jQuery.validator.addMethod("phone", function(value, element) {
    ...
    return this.optional(element) || (tel.test(value) || (value.length == 11 && mobile.test(value)));
}, "电话号码格式错误");
...
jQuery.validator.addMethod("money_credit", function(value, element) {
    var money = /^(([1-9]\d*)|0)(\.\d{1,2})?$/;
