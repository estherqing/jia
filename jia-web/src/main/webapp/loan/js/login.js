$(function() {
	...
	$.ajax({
		...
		success: function(data, textStatus, jqXHR) {
			...
			//$("#isShengAn img").attr("src", data.data.systemName === "shengan" ? "images/code_shengan.png" : "images/code.png");
			...
			if (data.data.systemName === "shengan") {
                ...
                $("#isShengAn img").attr("src", "images/code_shengan.png");
                ...
                $("#isShengAn img").attr("src", "images/code_cherong.png");
                $("#isShengAn p").html("请扫描二维码下载车融网APP");
                document.title = '车融贷前'
            } else {
                $(".navbar-nav img").attr("src","images/login_logo.jpg");
                $("#isShengAn img").attr("src", "images/code.png");
