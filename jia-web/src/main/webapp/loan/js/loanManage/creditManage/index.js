...
//		});
	...
	"click .again": function(e, a, item, index) {
		...
		// window.parent.cache.creditId = item.id;
		// console.log(item.id);
...
handle = function(value, row, index) {
	...
	return ["<div class='btn-group btn-group-xs'>", "<button type='button' class='btn btn-primary dropdown-toggle' data-toggle='dropdown'>操作", "<span class='caret'></span>", "<span class='sr-only'>下拉切换</span>", "</button>", "<ul class='dropdown-menu' role='menu'>", "<li><a class='info'>查看详情</a></li>", modifyMenu, reStart, "</ul>", "</div>"].join("");
};
