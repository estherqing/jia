...
if(args['readonly']=='true'){
    $("#btn-opinion-save,#btn-cancel,#opinionSection").remove(); //去掉流程操作按钮和流程意见
}
            ...
            comn.ajax({
                ...
                success: function (res) {
                    ...
                    if (args['flow'] == 'cancel-task') {
                        ...
                        flowSubmit(interUrl.loanCancel.preSubmit, interUrl.loanCancel.submit2next, './Modal/loanManage/loanCancel/index.html', loanApplyId);
                    }
                }
            });
        })
