var payment,handle,tableEvent,paymentMode,paymentType,transStatus;
$(".today").getToday();
//获取机构地址
$("#orgList").getOrg();
//获取付款类型
...
paymentType = function (value, row, index) {
    return ['', '贷款申请资金部付款', '贷款申请分公司付款','贷款修改分公司确认','贷款修改资金部付款','贷款修改分公司付款','贷款作废分公司确认','车主贷分公司付款"'][value]
};
...
tableEvent={
    ...
    "click .reSubmit": function (e, a, item, index) {
        var payType = ['','AT','AP','RA','RT','RP','CA','CP'][item.paymentType];
