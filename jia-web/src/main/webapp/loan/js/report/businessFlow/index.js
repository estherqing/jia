...
tableEvent = {
	"click .info": function(e, a, item, index) {
		...
		return comn.addTab({
			title:"贷款详情",
			href: "./Modal/customManage/customer/loanDetail.html?id="+ item.loanInfoProjectId +"&projectId=" + item.loanInfoProjectId +"&space=LOAN&releventFlowNode=LOAN_QUERY&releventFlow=LOAN_QUERY"
		})
	}
};
...
$(function() {
  ...
  $('#exportBtn').click(function(){
    ...
    var downLink = interUrl.basic + interUrl.report.businessExport + "?" + search + '&uId=' + uId +'&exportType=1';
