var args, dataLoad_1, handle_1, handle_2, CustomerLoad, loanVal, messageCheck, selectCheck, fileSended1, fileSended2, _data;
args = comn.getArgs();
// 新增
...
handle_1 = function (value, row, index) {
    ...
    return ["<input type='checkbox' class='check1' data-documentDeliverId='" + row['id'] + "'" + fileList + " value='2'/>"].join("");
};
