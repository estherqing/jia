var table_sign_main, handle_sign_main, tableEvent_sign_main, table_sign_vice, handle_sign_vice, tableEvent_sign_vice, tableEvent_4, handle_4;
var getSign = null;
        ...
        $("#sureOption").unbind("click").click(function () {
			comn.ajax({
				...
				data: {
					...
					nodeKey: args['currentNode'] || args['releventFlowNode']
				},
				success: function(res){
					if(res.data.message){ tip({content: res.data.message}); }
				} 
			})
            comn.ajax({
                url: interUrl.myTask.editAssign,
