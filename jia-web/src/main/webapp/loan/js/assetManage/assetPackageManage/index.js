var dataLoad_1,dataLoad_2,dataLoad_3, handle_1,handle_2, handle_3, tableEvent;
...
dataLoad_2 = function(params) {
  tableData(params, {assetsPackageStatus: "1",assetsPackageId:assetsPackageId}, interUrl.mockList || interUrl.asset.getInAssetsPackage);
};
dataLoad_3 = function(params) {
  tableData(params, {assetsPackageStatus: "2",assetsPackageId:assetsPackageId}, interUrl.mockList || interUrl.asset.getInAssetsPackage);
};
...
tableEvent = {
  "click .info": function(e, a, item, index) {
    return comn.addTab({
      title:"查看详情",
      href: "./Modal/assetManage/assetPackageManage/assetDetail.html?loanApplyId="+item.relativeApplyId1+"&projectId="+item.projectId +"&assetsPackageId="+ assetsPackageId + "&space=LOAN" + "&releventFlowNode=ESTIMATE_LAUNCH&releventFlow=SECOND_HAND_CAR_ESTIMATE_FLOW"
    });
  },
  "click .add": function(e, a, item, index) {
    return comn.addTab({
      title:"添加资产",
      href: "./Modal/assetManage/assetPackageManage/add.html?id="+item.id
    });
  },
